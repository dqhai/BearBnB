...
panda = Pet.new(name: "Panda", address: "Bambooville", details: "eat, sleep, repeat", species: 'panda', diet: 'herbivorous', lifestyle: 'independent')
snek = Pet.new(name: "snek", address: "Bambooville", details: "eat, sleep, repeat", species: 'reptile', diet: 'carnivorous', lifestyle: 'independent')
eagle = Pet.new(name: "birdie", address: "am Baumwipfel 7", details: "eat, sleep, repeat", species: 'bird', diet: 'carnivorous', lifestyle: 'independent')
...
turtle = Pet.new(name: "Crush", address: "Bambooville", details: "eat, sleep, repeat", species: 'reptile', diet: 'omnivorous', lifestyle: 'independent')
